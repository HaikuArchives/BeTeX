...
MainTBar::MainTBar(BRect r,BubbleHelper* h) : BView(r,"maintbar",B_FOLLOW_NONE,B_WILL_DRAW)
{
	...
	AddChild(TBDelTmp = new TButton(NULL, tiler,new BMessage(K_CMD_DELETE_TEMP_FILES),DelTmpBitmap));
	...
	AddChild(TBViewLog = new TButton(NULL, tiler,new BMessage(K_CMD_VIEW_LOG_FILE),ViewLogBitmap));
	...
	AddChild(TBOpenTracker = new TButton(NULL, tiler,new BMessage(K_CMD_LAUNCH_TRACKER),TrackerBitmap));
	...
	AddChild(TBOpenTerminal = new TButton(NULL, tiler,new BMessage(K_CMD_LAUNCH_TERMINAL),TerminalBitmap));
	...
	AddChild(TBTexHtml = new TButton(NULL, tiler,new BMessage(K_CMD_COMPILE_TEXHTML),TexHtmlBitmap));
	...
	AddChild(TBPrevPDF = new TButton(NULL, tiler,new BMessage(K_CMD_LAUNCH_BE_PDF),PrevPDFBitmap));
	...
	AddChild(TBPrevHTML = new TButton(NULL, tiler,new BMessage(K_CMD_LAUNCH_HTMLVIEWER),PrevHTMLBitmap));
