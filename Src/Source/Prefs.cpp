...
Prefs::Prefs(BMessage* archive)
{
		...
		if(archive->FindData("generic_cmd_color", B_RGB_COLOR_TYPE, (const void **)&rc_tmp, &size) == B_OK)
		...
		if(archive->FindData("format_cmd_color", B_RGB_COLOR_TYPE, (const void **)&rc_tmp, &size) == B_OK)
		...
		if(archive->FindData("special_cmd_color", B_RGB_COLOR_TYPE, (const void **)&rc_tmp, &size) == B_OK)
		...
		if(archive->FindData("math_mode_color", B_RGB_COLOR_TYPE, (const void **)&rc_tmp, &size) == B_OK)
		...
		if(archive->FindData("punc_symbol_color", B_RGB_COLOR_TYPE, (const void **)&rc_tmp, &size) == B_OK)
